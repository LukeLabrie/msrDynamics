...
# h_overall_f = P*(hx_hwf1+hx_hwf2)/((F_to_K(1522)+F_to_K(1209))/2 - (F_to_K(180)+F_to_K(620))/2)
# hA_ft_hx = h_overall_f
# hA_ht_hx = h_overall_f

# h_overall_c = P*(hx_hwc1+hx_hwc2)/((T0_hhwc_h1+T0_hhwc_h2)/2 - (T0_hhwc_w2+(T0_hhwc_w1-20))/2)
